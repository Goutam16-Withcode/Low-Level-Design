...
int main() {
    ...
    NPC* alienCopied3 = dynamic_cast<NPC*>(alien->clone());
    alienCopied3->setName("Super Human");
    alienCopied3->setHealth(2000);
    alienCopied3->setAttack(100);
    alienCopied3->describe();
